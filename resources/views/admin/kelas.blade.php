...
<body>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-warning btn-edit" data-id="{{ json_encode($kelas) }}"><i class="fas fa-pen"></i></button>
                      <button class="btn btn-danger btn-hapus" data-id="{{ $kelas->id }}"><i class="fas fa-trash"></i></button>
                    </td>
                  </tr>
                  @endforeach
                  </tbody>
    ...
    <!-- /.content -->
    <div class="modal fade" id="kelasForm">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="simpanKelas" method="post" id="simpanForm">
                @csrf
                <input type="hidden" name="id" id="id">
                  ...
                  <div class="form-group">
                    <label>Guru</label>
                    <select class="form-control" name="wali" id="wali" required>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <form action="hapusKelas" method="get" id="hapusForm">
